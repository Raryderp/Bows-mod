...
public class bowStone extends ItemBow
{
    ...
    public bowStone(int var1, int var2)
    {
        super(var1);
        this.maxStackSize = 1;
    ...
    {
        this.itemIcon = var1.registerIcon("mod/StoneBow1");
        X0 = var1.registerIcon("mod/StoneBow");
        X1 = var1.registerIcon("mod/StoneBow2");
        X2 = var1.registerIcon("mod/StoneBow3");
        X3 = var1.registerIcon("mod/StoneBow4");
    }
    public Icon getIcon(ItemStack par1ItemStack, int par2, EntityPlayer player, ItemStack var4, int var5)
    {
        if(player.isUsingItem() && var4.itemID == iDiamondhunter.bowStone.itemID)
        {
            if (var4 != null && var4.getItem().itemID == iDiamondhunter.bowStone.itemID)
            {
                int k = var4.getMaxItemUseDuration() - var5;
            if (k >= 17) return X3;
            else if (k >= 7) return X2;
